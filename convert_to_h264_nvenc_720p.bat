...
set SETTINGS_ENCODE_ALWAYS=--enc spatial-aq=1 --enc temporal-aq=1 --enc aq-strength=8 --enc rc-lookahead=32 --enc rc=vbr --pix-format yuv420p --vfilter scale=1280:-2 --enc profile:v=high --enc level:v=3.1
